 ...
 =======================================================*/
	...
	if (!function_exists('mk_pagenavi')) { 
		function mk_pagenavi($query, $before = '', $after = '') {
		    ...
		    $pagenavi_options['first_text'] = __('First Page', 'imotion');
		    $pagenavi_options['last_text'] = __('Last Page', 'imotion');
		    $pagenavi_options['next_text'] = __("Next", "imotion");
		    $pagenavi_options['prev_text'] = __("Prev", "imotion");
