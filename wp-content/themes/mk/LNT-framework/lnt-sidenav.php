...
<div class="sb-social">
<?php
if ( get_theme_mod( 'mk_sl_twitter','http://www.twitter.com/' ) ){
echo '<a href="'. esc_url( get_theme_mod( 'mk_sl_twitter','http://www.twitter.com/' ) ).'" class="pixons-twitter-1"></a>';
}

if ( get_theme_mod( 'mk_sl_facebook', 'http://www.facebook.com/') ){
echo '<a href="'.esc_url( get_theme_mod( 'mk_sl_facebook','http://www.facebook.com/' ) ).'" class="pixons-facebook-1"></a>';
}

if ( get_theme_mod( 'mk_sl_pinterest', 'http://www.pinterest.com/' ) ){
echo '<a href="'.esc_url( get_theme_mod( 'mk_sl_pinterest','http://www.pinterest.com/' ) ).'" class="pixons-pinterest"></a>';
}

if ( get_theme_mod( 'mk_sl_instagram', 'http://www.instagram.com/' ) ){
echo '<a href="'.esc_url( get_theme_mod( 'mk_sl_instagram','http://www.instagram.com/' ) ).'" class="pixons-instagram"></a>';
}
if ( get_theme_mod( 'mk_sl_gplus', 'http://www.gplus.google.com/' ) ){
echo '<a href="'.esc_url( get_theme_mod( 'mk_sl_gplus','http://www.gplus.google.com/' ) ).'" class="pixons-google_plus"></a>';
}

if ( get_theme_mod( 'mk_sl_dribble', 'http://www.dribble.com/' ) ){
echo '<a href="'.esc_url( get_theme_mod( 'mk_sl_dribble','http://www.dribble.com/' ) ).'" class="pixons-dribbble"></a>';
}
